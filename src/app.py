...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball training and seasonal games",
        "schedule": "Mondays, Thursdays, 4:30 PM - 6:30 PM",
        "max_participants": 15,
    ...
    "Debate Team": {
        ...
        "max_participants": 16,
        "participants": ["oliver@mergington.edu", "emma.h@mergington.edu"]
    },
    "Science Club": {
